...
public record CustomBookResponseDto(Long bookInfoId, Long userBookId, String title, String author, String imgPath, String publisher, Long pageCount, ReadStatus readStatus, Double myRating, String myOneLine){
